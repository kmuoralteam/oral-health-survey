...
function submitForm() {
    ...
    const oralIssues = document.getElementById("oralIssues").value ? document.getElementById("oralIssues").value : "未填寫";
    const otherQuestions = document.getElementById("otherQuestions").value ? document.getElementById("otherQuestions").value : "無其他問題";
